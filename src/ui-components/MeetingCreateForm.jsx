...
export default function MeetingCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setLocationLink(initialValues.locationLink);
    setStatus(initialValues.status);
    setAgendaItems(initialValues.agendaItems);
    setCurrentAgendaItemsValue(undefined);
    setCurrentAgendaItemsDisplayValue("");
    setActionItems(initialValues.actionItems);
    ...
    setRelationshipMeetingsId(initialValues.relationshipMeetingsId);
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          const modelFieldsToSave = {
            ...
            locationLink: modelFields.locationLink,
            status: modelFields.status,
            relationshipMeetingsId: modelFields.relationshipMeetingsId,
          };
          const meeting = (
            await API.graphql({
          ...
          const promises = [];
          promises.push(
            ...agendaItems.reduce((promises, original) => {
              promises.push(
                API.graphql({
                  ...
                  variables: {
                    input: {
                      id: original.id,
                      meetingAgendaItemsId: meeting.id,
                    },
                  },
                })
              );
          ...
          promises.push(
            ...actionItems.reduce((promises, original) => {
              promises.push(
                API.graphql({
                  ...
                  variables: {
                    input: {
                      id: original.id,
                      meetingActionItemsId: meeting.id,
                    },
                  },
                })
              );
